  ...
  return authRequest(
    "/company-settings/me",
    {
      ...
      body: JSON.stringify({
        ...
        defaultPaymentTerm: payload?.defaultPaymentTerm,
        defaultTaxLabel: payload?.defaultTaxLabel,
        numberingMode: payload?.numberingMode,
        stockWarning: payload?.stockWarning,
        negativeStock: payload?.negativeStock,
        discountMode: payload?.discountMode,
        discountTiming: payload?.discountTiming,
        additionalAdjustment: payload?.additionalAdjustment,
        shippingCharge: payload?.shippingCharge,
        taxMode: payload?.taxMode,
        salesRoundingMode: payload?.salesRoundingMode,
        salespersonField: payload?.salespersonField,
      }),
    },
    onSessionUpdate,
  );
